...
class AdminDetailEwallet extends StatefulWidget {
  final int id;
  final String nama;
  final String icon;
  const AdminDetailEwallet(
      {super.key, required this.id, required this.nama, required this.icon});

  @override
  State<AdminDetailEwallet> createState() => _AdminDetailEwalletState();
}

class _AdminDetailEwalletState extends State<AdminDetailEwallet> {
  @override
